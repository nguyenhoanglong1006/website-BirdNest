...
export declare class LazyLoadImageDirective implements OnChanges, AfterContentInit, OnDestroy {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<LazyLoadImageDirective, "[lazyLoad]", never, { "lazyImage": "lazyLoad"; "defaultImage": "defaultImage"; "errorImage": "errorImage"; "scrollTarget": "scrollTarget"; "customObservable": "customObservable"; "offset": "offset"; "useSrcset": "useSrcset"; "decode": "decode"; }, { "onLoad": "onLoad"; }, never>;
}
